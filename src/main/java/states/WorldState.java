...
public final record WorldState(int trees, int fish, Map<String, AgentState> agents, int day, int maxCost) {
    ...
    public WorldState changeTreeCount(int newTreeCount) { return new WorldState(trees + newTreeCount, fish, agents, day); }
    public WorldState changeFishCount(int newFishCount) { return new WorldState(trees, fish + newFishCount, agents, day); }
